...
pub enum ModelConfig {
  /// Qwen2.5-Coder 0.5B model (494M params) - Proven optimal for branch names
  #[default]
  Qwen25Coder05B,
  ...
  Qwen25Coder3B,
  /// Qwen3-0.6B model (600M params) - Next generation Qwen architecture
  Qwen3_06B,
...
impl ModelConfig {
  ...
  pub fn download_urls(&self) -> Vec<(&'static str, &'static str, Option<u32>)> {
    match self {
      ModelConfig::Qwen25Coder05B => vec![
        ("config.json", "https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B/resolve/main/config.json", None),
        (
          "model.safetensors",
          "https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B/resolve/main/model.safetensors",
          Some(500_000_000),
        ),
        ("tokenizer.json", "https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B/resolve/main/tokenizer.json", None),
        (
          "tokenizer_config.json",
          "https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B/resolve/main/tokenizer_config.json",
          None,
        ),
        ("merges.txt", "https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B/resolve/main/merges.txt", None),
      ],
      ...
      ModelConfig::Qwen3_06B => vec![
        ("config.json", "https://huggingface.co/Qwen/Qwen3-0.6B/resolve/main/config.json", None),
        (
          "model.safetensors",
          "https://huggingface.co/Qwen/Qwen3-0.6B/resolve/main/model.safetensors",
          Some(600_000_000),
        ),
        ("tokenizer.json", "https://huggingface.co/Qwen/Qwen3-0.6B/resolve/main/tokenizer.json", None),
        ("tokenizer_config.json", "https://huggingface.co/Qwen/Qwen3-0.6B/resolve/main/tokenizer_config.json", None),
        ("merges.txt", "https://huggingface.co/Qwen/Qwen3-0.6B/resolve/main/merges.txt", None),
      ],
  ...
  pub fn is_qwen3_architecture(&self) -> bool {
    matches!(self, ModelConfig::Qwen3_06B | ModelConfig::Qwen3_17B)
  }

  pub fn is_qwen25_architecture(&self) -> bool {
    matches!(self, ModelConfig::Qwen25Coder05B | ModelConfig::Qwen25Coder15B | ModelConfig::Qwen25Coder3B)
  }
