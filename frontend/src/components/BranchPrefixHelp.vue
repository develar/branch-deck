<template>
  <UModal title="Configure Branch Prefix">
    ...
    <template #body>
      <div class="space-y-4">
        <p>The branch prefix is automatically prepended to your virtual branches. Setting a personal prefix (like your username) helps identify your branches in a shared repository.</p>
        ...
        <div class="p-4 bg-info-50 dark:bg-info-900/20 rounded-lg">
          ...
          <p class="text-sm">
            If you set <span class="font-mono">v-branch.branchPrefix</span> to <span class="font-mono">john</span> and create a virtual branch from commits with prefix <span class="font-mono">feature-login</span>, the branch will be named:
          </p>
